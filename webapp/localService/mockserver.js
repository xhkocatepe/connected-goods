sap.ui.define([
 ...
 "use strict";
    ...
    innerFormulaCalculation.generateResult = function (formulaObj, data, dataPoint, entity, modelHelper) {
        ...
        switch (formulaObj[0].type) {
            ...
            case "property":
                ...
                break;
            case "value":
                result = innerFormulaCalculation.parseFormulaValue(formulaObj[0]);
                break;
            default:
    ...
    /**
     * @description Tries to convert a value to its typed value. If no suitable conversion can be found, the provided string is returned.
     */
    innerFormulaCalculation.parseFormulaValue = function (formulaObj) {
        var result;
        var value = formulaObj.value;
        ...
        if (formulaObj.computedType === 'boolean') {
            result = innerFormulaCalculation.parseBoolean(value);
            if (typeof result === 'boolean') {
                return result;
            }
        }

        // no suitable conversion found, return the value as is was.
        return value;
    };

    /**
     * @description Converts a string to a boolean. Returns undefined if the conversion fails.
     */
    innerFormulaCalculation.parseBoolean = function (value) {
        var result;
        if (value) {
